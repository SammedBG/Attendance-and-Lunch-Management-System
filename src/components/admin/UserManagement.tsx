...
const UserManagement: React.FC = () => {
  ...
  const [selectedRole, setSelectedRole] = useState<'admin' | 'employee' | 'chef'>('employee');
  ...
  const handleRoleEdit = (userId: string, currentRole: 'admin' | 'employee' | 'chef') => {
                  ...
                  <tr key={user.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {editingUser === user.id ? (
                        <select
                          value={selectedRole}
                          onChange={(e) => setSelectedRole(e.target.value as 'admin' | 'employee' | 'chef')}
